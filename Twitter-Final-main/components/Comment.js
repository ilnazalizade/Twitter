...
export default function Comment({comment, commentId, originalPostId}) {
    ...
    return (
        <div className="flex p-3 cursor-pointer border-b border-gray-200 pl-20 w-full">
            {/* image */}
        ...
        <Moment fromNow>{comment?.timestamp?.toDate()}</Moment>
                ...
                {/* post text */}
                <p className="text-gray-800 text-[15px sm:text-[16px] mb-2 block w-full break-all">{comment?.comment}</p>
                ...
                <div className="flex items-center select-none">
                    ...
                    <div className="flex items-center">
                        {hasLiked ? (
                            <HeartIconFilled onClick={likeComment}
